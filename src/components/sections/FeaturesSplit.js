          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  In previous step I have created a small package holding image exif data and currently NFT can hold 256 bit in comments, exif data will be stored together with NFT making it imutable.
                  </p>
              </div>
              <div className={
                classNames(
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  ...
                  In this case this site will recieve a simple interface allowing you to upload images. 
                  And as a bonus I will try and make the time to create a mobile camera app that directly mints the NFT.
                  </p>
              </div>
              <div className={
                classNames(
